...
#define SECRET_SSID "mikemighty"    // replace MySSID with your WiFi network name
#define SECRET_PASS "wewillrockyou010"  // replace MyPassword with your WiFi password

#define SECRET_CH_ID 2084869     // replace 0000000 with your channel number
#define SECRET_READ_APIKEY "DI8R389SECOC295N"   // replace XYZ with your channel write API Key
